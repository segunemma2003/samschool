...
import { ArrowRight, Clock, ListChecks, Shield, Camera, ScanFace } from 'lucide-react';
        ...
        <div className="glass-panel p-8 md:p-10">
          ...
          <div className="bg-muted/50 rounded-lg p-4 mb-8">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li>• The camera feature is used for proctoring purposes.</li>
              <li>• You must enable your camera and verify your face before starting.</li>
            ...
            <div>
              <Card className="h-full flex flex-col">
                <div className="p-4 border-b border-border">
                  ...
                  <p className="text-sm text-muted-foreground">Please enable your camera and position your face in the frame</p>
                </div>
                ...
                <div className="p-4 bg-muted/30 border-t border-border">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`px-2 py-1 rounded-full text-xs ${isCameraActive ? 'bg-green-500/10 text-green-500' : 'bg-muted text-muted-foreground'}`}>
                      {isCameraActive ? 'Enabled' : 'Disabled'}
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className={`px-2 py-1 rounded-full text-xs ${isCameraVerified ? 'bg-green-500/10 text-green-500' : 'bg-muted text-muted-foreground'}`}>
                      {isCameraVerified ? 'Verified' : 'Not Detected'}
                    </div>
                  </div>
                </div>
              </Card>
            ...
            <div>
              <Card className="h-full p-6 flex flex-col justify-center items-center text-center">
                ...
                <Button
                  ...
                  size="lg"
                  className="w-full"
                  disabled={!isCameraActive || !isCameraVerified}
                >
                  {!isCameraActive ? (
                    "Enable Camera First"
                  ) : !isCameraVerified ? (
                ...
                {isCameraActive && !isCameraVerified && (
                  <p className="text-xs text-muted-foreground mt-2">
