...
const AffectiveDomain = ({ affectiveDomain }) => {
  return (
    <div className="print:break-inside-avoid my-3 animate-fade-in" style={{ animationDelay: '0.3s' }}>
      <h3 className="text-lg font-semibold mb-2 bg-report-blue/10 py-1 px-2 rounded text-report-dark">
        AFFECTIVE DOMAIN
      </h3>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {affectiveDomain.map((item, index) => (
          <div
            key={index}
